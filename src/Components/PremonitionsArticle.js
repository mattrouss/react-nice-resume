  ...
  render() {
    return (
      <div>
        ...
        <img className="project-image" src={"/images/portfolio/premonitions_culprit.png"}></img>
        <p className="image-subtext">The culprit who is going to get you!</p>
        <p className="paragraph">
        ...
        <img className="project-image" src={"/images/portfolio/premonitions_innocent.png"}></img>
        <p className="image-subtext">Don't accuse innocent bystanders!</p>
        <h2 className="title">
            Let's do it again!
        </h2>
        <p className="paragraph">
